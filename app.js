...
const dict = {
  ru: {
    ...
    about_p2: "Моя работа — это не только вкус, но и сервис: подбор продуктов, меню под запрос и сезон, аккуратная подача, чистота на кухне и комфорт гостей. Вы получаете ресторанный уровень у себя дома — без суеты  с вниманием к деталям.",
